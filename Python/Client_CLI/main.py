...
def print_update_menu():
    ...
    print('2. Update Clusters of Device')
    print('------------------------------------')
        ...
        if main_input == 0:
            ...
            while True:
                ...
                try:
                    ...
                    if update_input not in range(3):
                        raise ValueError
                                ...
                                while True:
                                    ...
                                    try:
                                        ...
                                        if update_choice != 0:
                                            ...
                                            # By default points to cluster endpoint
                                            update_endpoint = 'update/cluster/'

                                            if update_input == 1:
                                                # Device Mode Call, point to device endpoint
            ...
            while True:
                ...
                try:
                    ...
                    if register_input not in range(4):
                        raise ValueError
