...
gw_01_ip=192.168.1.9
gw_02_ip=192.168.1.12
...
sshpass -p $passwd scp /mnt/d/Projects/Skripsi/Tests/ESP_OTA/Existing/run.ino.nodemcu.bin pi@$gw_02_ip:/home/pi/gateway_code/code/run.ino.nodemcu.bin

echo 'Sending to end device...'
plink pi@$gw_01_ip -pw $passwd python3 /home/pi/gateway_code/code/espotabatch.py
